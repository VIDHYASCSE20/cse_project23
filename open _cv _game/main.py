...
_, frm = cap.read() 
frm = cv2.flip(frm, 1)
cv2.putText(frm, "score: "+str(gen.points), (width_ - 250, 50),
...
cv2.putText(frm, "GAME_OVER!\nPress r to replay", (100, 100),
cv2.FONT_HERSHEY_PLAIN, 4, (255, 0, 0), 3)
cv2.putText(frm, "Score : "+str(gen.points), (100, 180),
cv2.FONT_HERSHEY_PLAIN, 4, (255,0,0), 3)
gen.points = 0 
# bird
...
hand.HAND_CONNE
#cv2.putText(frm,"frame_rate:"+str(int(1/(time.time()-ss))),(50,50), 
